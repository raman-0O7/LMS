...
export const CourseSidebarItem = ({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex items-center text-sm text-slate-500 font-[500] gap-x-2 pl-6 transition-all hover:text-slate-600 hover:bg-slate-300/20",
        isActive && "text-slate-700 bg-slate-200/20 hover:bg-slate-200/20 ghover:text-slate-700",
